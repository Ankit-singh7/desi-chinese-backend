...
module.exports.setRouter = (app) => {
    ...
    */
    ...
    // Employee payroll (Shiftly V2 — matches habib-backend / Shiftly frontend)
    ...
    app.get(`${baseUrl}/list/:employeeId`, adminController.getAttendanceList);

    app.get(`${baseUrl}/fine/list`, adminController.getFineList);
    app.post(`${baseUrl}/fine/save`, adminController.saveFine);

    app.get(`${baseUrl}/employee-notes`, adminController.getEmployeeNotes);
    app.post(`${baseUrl}/employee-notes`, adminController.saveEmployeeNote);
    app.put(`${baseUrl}/employee-notes/:id`, adminController.updateEmployeeNote);
    app.delete(`${baseUrl}/employee-notes/:id`, adminController.deleteEmployeeNote);
